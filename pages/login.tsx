        ...
        {/* ... */}
          <div className="mt-8">
            <div className="flex items-center justify-between">
              <label
                htmlFor="email"
                className={`${styles.label} block mb-3 font-sans text-blue-900`}
              >
                Email
              </label>
            </div>
            ...
            />
            {errors.email && (
              <p className={`${styles.error} text-red-400`}>{errors.email.message}</p>
            )}
          </div>
          ...
          <div className="mt-8">
            ...
            />
            {errors.password && (
              <p className={`${styles.error} text-red-400`}>{errors.password.message}</p>
            )}
          </div>
          ...
          <div className="flex justify-center pt-8">
            ...
            >
              <p className={`${styles.buttonText} capitalize text-white font-normal`}>Submit</p>
            </button>
          </div>
        </form>
      </FormProvider>
